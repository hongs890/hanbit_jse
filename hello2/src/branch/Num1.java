...
public class Num1 {
	...
	public static void main(String[] args) {
		...
		if (ave1 > ave2 && ave1 > ave3 && ave2 > ave3) {
			...
			result3 = ave3;
			name3 = student3;
		} else if (ave1 > ave2 && ave1 > ave3 && ave3 > ave2){
			...
			result3 = ave2;
			name3 = student2;
		} else if (ave2 > ave1 && ave2 > ave3 && ave1 > ave3){
		...
		} else if(ave2 > ave1 && ave2 > ave3 && ave3 > ave1){
			result1 = ave2;
			name1 = student2;
			result2 = ave3;
			name2 = student3;
		...
		} else if (ave3 > ave2 && ave3 > ave1 && ave1 > ave2) {
			...
			result3 = ave3;
			name3 = student3;
		} else if (ave3 > ave2 && ave3 > ave1 && ave2 > ave1){
